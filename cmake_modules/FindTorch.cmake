...
SET(LOCAL_TORCH_PATH_INCLUDE "/home/slam-emix/Workspace/lib/libtorch/include")
SET(LOCAL_TORCH_PATH_LIB "/home/slam-emix/Workspace/lib/libtorch/lib")
...
FIND_PATH(PYTORCH_DIR torch/csrc/api/include/torch/torch.h 
  PATHS
    ...
    "${LOCAL_TORCH_PATH_INCLUDE}"
    NO_DEFAULT_PATH
  )
  
MESSAGE("Path Torch : ${PYTORCH_DIR}")
...
SET(TORCH_LIBDIR ${LOCAL_TORCH_PATH_LIB})
